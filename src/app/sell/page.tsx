                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
                             <ScrollReveal delay={100} className="flex">
                                <Card className="flex flex-col shadow-xl border-2 hover:border-primary/50 transition-all group w-full">
                             ...
                             <ScrollReveal delay={200} className="flex">
                                <Card className="flex flex-col border-primary/20 bg-primary/5 shadow-xl border-2 hover:border-primary/50 transition-all group w-full">
                                    <CardHeader className="pb-4">
